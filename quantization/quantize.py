...
from .layer_transform import switch_layers, replace_op, restore_op, set_quant_minmax, merge_batchnorm, quantize_targ_layer
...
def quantize_model(model, args):
    ...
    data = torch.ones((4, 3, 32, 32)) #.to(args.device)
